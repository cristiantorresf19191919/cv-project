...
const neonPhotoReveal = {
  hidden: { opacity: 0, scale: 0.8, filter: 'brightness(1.5) blur(8px)' },
  visible: {
    opacity: 1,
    scale: 1,
          ...
          <motion.div variants={heroItem} className={s.stats}>
            {data.stats.map((stat, i) => (
              <motion.div
                ...
                transition={{ delay: 1 + i * 0.12, duration: 0.5, type: 'spring' as const, stiffness: 250 }}
              >
