  ...
  return (
    <div className={s.template}>
      <div className={s.hero}>
        {/* Photo on left for Editorial */}
        <motion.div
          className={s.photoSide}
          initial="hidden"
          animate="visible"
        ...
        <motion.div initial="hidden" animate="visible" variants={heroContainer}>
          ...
          <motion.div variants={heroItem} className={s.divider} />
          ...
          <motion.div variants={heroItem} className={s.stats}>
            {data.stats.map((stat, i) => (
              <motion.div
                ...
                transition={{ delay: 1 + i * 0.12, duration: 0.5, type: 'spring' as const, stiffness: 200 }}
              >
