...
import s from '@/styles/blueprint.module.css';
...
export default function Blueprint() {
  ...
  return (
    <div className={s.template}>
      {/* Hero — technical drawing layout */}
      <motion.div className={s.hero} initial="hidden" animate="visible" variants={heroContainer}>
        <div>
          ...
          <div className={s.photoWrap}>
            <div className={s.photoFrame}>
              <div className={s.photoInner}>
                <Image src={photoUrl} alt="Cristian Torres" fill sizes="220px" className="profile-photo" priority style={{ objectFit: 'cover' }} />
              </div>
            </div>
            <div className={s.photoLabel}>REF: PROFILE — 1:1</div>
          </div>
        </motion.div>
      </motion.div>
      ...
      {/* Skills */}
      <div className={s.sec}>
        <SectionHeader tag="Specifications" title="Technical Skills" tagClass={s.secTag} titleClass={s.secTitle} wrapperClass={s.secH} />
      ...
      <div className={s.sec} data-code-showcase>
        <SectionHeader tag="Draft Mode" title="Live Coding" tagClass={s.secTag} titleClass={s.secTitle} wrapperClass={s.secH} />
        <CodeShowcase />
      </div>

      {/* Experience */}
      <div className={s.sec}>
        <SectionHeader tag="Revision History" title="Experience" tagClass={s.secTag} titleClass={s.secTitle} wrapperClass={s.secH} />
        <div className={s.tl}>
          {data.exp.map((exp, i) => (
      ...
      {data.projects.length > 0 && (
        <div className={s.sec}>
          <SectionHeader tag="Schematics" title="Projects" tagClass={s.secTag} titleClass={s.secTitle} wrapperClass={s.secH} />
