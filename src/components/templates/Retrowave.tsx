...
import s from '@/styles/retro.module.css';
...
export default function Retrowave() {
  ...
  return (
    <div className={s.template}>
          ...
          <motion.div variants={photoReveal}>
            <div className={s.photoOuter}>
              ...
              <div className={s.photoClip}>
                <Image src={photoUrl} alt="Cristian Torres" fill sizes="160px" className="profile-photo" priority />
              </div>
            </div>
          </motion.div>
      ...
      {/* Skills */}
      <div className={s.sec}>
        <SectionHeader tag="Arsenal" title="Tech Stack" tagClass={s.secTag} titleClass={s.secTitle} wrapperClass={s.secH} />
      ...
      <div className={s.sec} data-code-showcase>
        <SectionHeader tag="Uplink" title="Live Coding" tagClass={s.secTag} titleClass={s.secTitle} wrapperClass={s.secH} />
        <CodeShowcase />
      </div>
      ...
      {/* Experience */}
      <div className={s.sec}>
        <SectionHeader tag="Log" title="Experience" tagClass={s.secTag} titleClass={s.secTitle} wrapperClass={s.secH} />
        <div className={s.tl}>
          {data.exp.map((exp, i) => (
      ...
      {data.projects.length > 0 && (
        <div className={s.sec}>
          <SectionHeader tag="Showcase" title="Projects" tagClass={s.secTag} titleClass={s.secTitle} wrapperClass={s.secH} />
      ...
      <div id="contact" className={s.sec}>
        <SectionHeader tag="Signal" title="Get In Touch" tagClass={s.secTag} titleClass={s.secTitle} wrapperClass={s.secH} />
